    ...
    <div className='slider-wrapper'>
        <Slider {... settings}>
            {sliderItems.map((item, index) => (
                <div key={index}>
                    <div 
                    className='h-[50vh] xl:h-[70vh] bg-center bg-cover'
                    style={{ backgroundImage: `url(${item.bgImg})`}}>
                        <div className="slide-content bg-black/75 h-[50vh] xl:h-[70vh] w-full text-white flex flex-col items-start justify-center px-8 pt-12 flex justify-center items-center">
