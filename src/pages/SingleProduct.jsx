...
const SingleProduct = () => {
	...
	return (
		<div className="h-[80vh] flex items-center justify-center py-4 gap-8 flex-col px-4 xl:flex-row container max-w-[1200px] mx-auto">
			...
			<div className="flex flex-col w-1/2 ">
				...
				<h4 className="font-bold md:text-[17px] text-[12px] mt-4  underline underline-offset-8">
					{singleProduct?.title}
				</h4>

				<p className="mt-4  underline underline-offset-8">{singleProduct.category}</p>

				<p className="mt-4 ">
					{" "}
					<span className="font-bold underline underline-offset-4"> Description:</span> <br />
